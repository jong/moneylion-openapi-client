...
class LeadSessionInformation(BaseModel):
    """
    ...
    browser_fingerprint: Optional[StrictStr] = Field(default=None, alias="browserFingerprint")
    __properties: ClassVar[List[str]] = ["ipAddress", "userAgent", "browserFingerprint"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "browserFingerprint": obj.get("browserFingerprint")
        })
        return _obj
