...
class ConversionEventData(BaseModel):
    ...
    ConversionEventData
    """ # noqa: E501
    payout_in_cents: Optional[StrictInt] = Field(default=None, description="The number of cents paid out for the conversion event. ", alias="payoutInCents")
    product_type: Optional[ProductType] = Field(default=None, alias="productType")
    __properties: ClassVar[List[str]] = ["payoutInCents", "productType"]
