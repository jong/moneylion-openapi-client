...
class Originator(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["key", "name", "description", "images", "disclaimer", "companyUuid", "financialInstitutionUuid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "images": [OriginatorImage.from_dict(_item) for _item in obj["images"]] if obj.get("images") is not None else None,
