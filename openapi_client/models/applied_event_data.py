...
class AppliedEventData(BaseModel):
    """
    AppliedEventData
    """ # noqa: E501
    amount: Optional[StrictInt] = Field(default=None, description="The dollar amount of the offer that was applied for. ")
    product_type: Optional[ProductType] = Field(default=None, alias="productType")
    __properties: ClassVar[List[str]] = ["amount", "productType"]
