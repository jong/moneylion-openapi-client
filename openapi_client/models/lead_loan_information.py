...
class LeadLoanInformation(BaseModel):
    """
    LeadLoanInformation
    """ # noqa: E501
    purpose: Optional[LoanPurpose] = None
    loan_amount: Optional[StrictInt] = Field(default=None, alias="loanAmount")
    __properties: ClassVar[List[str]] = ["purpose", "loanAmount"]
